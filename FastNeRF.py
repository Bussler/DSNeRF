...
class FastNeRF(nn.Module):
    ...
    def __init__(self, D_pos = 8, D_view = 4, W_pos = 384, W_view = 256, input_ch = 3, input_ch_views = 3, output_ch = 3, output_ch_view = 1, skips_pos = [4], skips_view = [], use_viewdirs = True, cache_factor = 4, cache_resolution = 768):
        ...
        self.position_final = nn.Linear(W_pos, 3 * cache_factor)
        ...
        self.view_final = nn.Linear(W_view // 2, 1 * cache_factor)
